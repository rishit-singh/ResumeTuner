...
class ResumeBot:
    ...
    def Tune(self, jobDescription):
        self.Bot.Prompt(f"Tune and recreate this resume to match this {jobDescription}. Return a full resume with a summary, relevant strengths, and skills, in a fancy Markdown format.")
